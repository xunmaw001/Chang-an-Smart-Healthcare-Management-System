...
//                            bingliEntity.setBingliName(data.get(0));                    //患者姓名 要改的
//                            bingliEntity.setHuanzhePhone(data.get(0));                    //患者手机号 要改的
//                            bingliEntity.setHuanzheIdNumber(data.get(0));                    //患者身份证号 要改的
//                            bingliEntity.setBingliFile(data.get(0));                    //病例文件 要改的
//                            bingliEntity.setBingliContent("");//照片
