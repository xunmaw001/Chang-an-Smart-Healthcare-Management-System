...
//                            shangpinEntity.setShangpinName(data.get(0));                    //药品名称 要改的
//                            shangpinEntity.setShangpinPhoto("");//照片
//                            shangpinEntity.setShangpinTypes(Integer.valueOf(data.get(0)));   //药品类型 要改的
//                            shangpinEntity.setShangpinKucunNumber(Integer.valueOf(data.get(0)));   //药品库存 要改的
//                            shangpinEntity.setShangpinOldMoney(data.get(0));                    //药品原价 要改的
