...
public class YuyueView extends YuyueEntity implements Serializable {
    private static final long serialVersionUID = 1L;
		...
		* 预约状态的值
		*/
		private String yuyueYesnoValue;
	...
	public YuyueView(YuyueEntity yuyueEntity) {
		try {
			...
			* 获取： 预约状态的值
			*/
			public String getYuyueYesnoValue() {
				return yuyueYesnoValue;
			}
			/**
			* 设置： 预约状态的值
			*/
			public void setYuyueYesnoValue(String yuyueYesnoValue) {
				this.yuyueYesnoValue = yuyueYesnoValue;
			}
