            ...
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '药品名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.shangpinName" placeholder="药品名称" clearable></el-input>
                    </el-form-item>
                                         
                    <el-form-item :label="contents.inputTitle == 1 ? '药品类型' : ''">
                        <el-select v-model="searchForm.shangpinTypes" placeholder="请选择药品类型">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '开始药品库存' : ''">
                      <el-input v-model="searchForm.shangpinKucunNumberStartSearch"
                                placeholder="请输入开始药品库存" clearable></el-input>
                    </el-form-item>
                    <el-form-item :label="contents.inputTitle == 1 ? '' : ''">
                      =》
                    </el-form-item>
                    <el-form-item :label="contents.inputTitle == 1 ? '结束药品库存' : ''">
                        <el-input v-model="searchForm.shangpinKucunNumberEndSearch"
                                  placeholder="请输入结束药品库存" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/changanyiliao/upload/shangpinOrderMuBan.xls"
                        >批量导入药品订单数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpinOrder','导入导出')"
                    ...
                    <el-table-column width="300" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && role == '用户'" type="primary" icon="el-icon-sold-out" size="mini" @click="refund(scope.row.id)">退款</el-button>
                                  <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 3 && role == '管理员'" type="primary" icon="el-icon-reading" size="mini" @click="deliver(scope.row.id)">发货</el-button>

                                 <el-button v-if="isAuth('shangpinOrder','订单') && scope.row.shangpinOrderTypes == 4 && role == '用户'" type="primary" icon="el-icon-reading" size="mini" @click="receiving(scope.row.id)">收货</el-button>
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '药品照片': 'shangpinPhoto',
                     '药品类型': 'shangpinTypes',
                     '药品库存': 'shangpinKucunNumber',
                     '药品原价': 'shangpinOldMoney',
