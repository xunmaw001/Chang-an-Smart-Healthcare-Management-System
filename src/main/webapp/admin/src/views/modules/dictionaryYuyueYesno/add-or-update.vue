    ...
    <div class="addEdit-block">
        ...
        >
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type!='info'"  label="预约状态名称" prop="indexName">
                        <el-input v-model="ruleForm.indexName"
                                  placeholder="预约状态名称" clearable  :readonly="ro.indexName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="预约状态名称" prop="indexName">
                            <el-input v-model="ruleForm.indexName"
                                      placeholder="预约状态名称" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
        ...
        methods: {
            ...
            onSubmit() {
                if((!this.ruleForm.codeIndex)&& !this.$validate.isNumber(this.ruleForm.codeIndex)){
                    this.$message.error('预约状态编码必须为数字');
                    return
                }
                if((!this.ruleForm.indexName)){
                    this.$message.error('预约状态名称不能为空');
                    return
                }
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        let ruleForm = this.ruleForm;
                        ruleForm["dicCode"]="yuyue_yesno_types";
                        ruleForm["dicName"]="预约状态名称";
                        this.$http({
