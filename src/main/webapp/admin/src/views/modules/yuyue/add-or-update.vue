    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="花费金额" prop="yuyueTruePrice">
                       <el-input v-model="ruleForm.yuyueTruePrice"
                                 placeholder="花费金额" clearable  :readonly="ro.yuyueTruePrice"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="花费金额" prop="yuyueTruePrice">
                           <el-input v-model="ruleForm.yuyueTruePrice"
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    yishengId: false,
                    yonghuId: false,
                    yuyueTruePrice: false,
                    yuyueYesnoTypes: false,
                    yuyueTime: false,
                    insertTime: false,
                },
                ruleForm: {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.yuyueYesnoTypesOptions = data.data.list;
                    }
                });
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yuyueTruePrice'){
                          this.ruleForm.yuyueTruePrice = obj[o];
                          this.ro.yuyueTruePrice = true;
                          continue;
                      }
                      if(o=='yuyueYesnoTypes'){
                          this.ruleForm.yuyueYesnoTypes = obj[o];
                          this.ro.yuyueYesnoTypes = true;
                          continue;
                      }
                      if(o=='yuyueTime'){
