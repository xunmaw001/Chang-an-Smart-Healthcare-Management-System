            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="类型" prop="yishengCollectionTypes">
                        <el-select v-model="ruleForm.yishengCollectionTypes" placeholder="请选择类型">
                            <el-option
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yishengCollectionTypes'){
                          this.ruleForm.yishengCollectionTypes = obj[o];
                          this.ro.yishengCollectionTypes = true;
                          continue;
                      }
                      if(o=='insertTime'){
