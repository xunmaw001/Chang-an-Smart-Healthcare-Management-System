        ...
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="是否坐诊" prop="zuozhenTypes">
                        <el-select v-model="ruleForm.zuozhenTypes" :disabled="ro.zuozhenTypes" placeholder="请选择是否坐诊">
                            <el-option
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="医生详情" prop="yishengContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.yishengContent" label="医生详情" prop="yishengContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   zuozhenTypes: [
                              { required: true, message: '是否坐诊不能为空', trigger: 'blur' },
                              {  pattern: /^[1-9][0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   yishengContent: [
                              { required: true, message: '医生详情不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
            ...
            init(id,type) {
                ...
                if(this.type=='info'||this.type=='else'){
                    ...
                    for (var o in obj){
                      ...
                      if(o=='yishengName'){
                          this.ruleForm.yishengName = obj[o];
                          this.ro.yishengName = true;
                          continue;
                      }
                      if(o=='yishengPhone'){
                          this.ruleForm.yishengPhone = obj[o];
                          this.ro.yishengPhone = true;
                          continue;
                      }
                      if(o=='yishengPhoto'){
                          this.ruleForm.yishengPhoto = obj[o];
                          this.ro.yishengPhoto = true;
                          continue;
                      }
                      if(o=='yishengEmail'){
                          this.ruleForm.yishengEmail = obj[o];
                          this.ro.yishengEmail = true;
                          continue;
                      }
                      if(o=='sexTypes'){
                      ...
                      if(o=='keshiTypes'){
                          this.ruleForm.keshiTypes = obj[o];
                          this.ro.keshiTypes = true;
                          continue;
                      }
                      if(o=='zhiweiTypes'){
                          this.ruleForm.zhiweiTypes = obj[o];
                          this.ro.zhiweiTypes = true;
                          continue;
                      }
                      if(o=='zuozhenTypes'){
                          this.ruleForm.zuozhenTypes = obj[o];
                          this.ro.zuozhenTypes = true;
                          continue;
                      }
                      if(o=='yishengContent'){
                          this.ruleForm.yishengContent = obj[o];
                          this.ro.yishengContent = true;
                          continue;
                      }
                    }
                }
