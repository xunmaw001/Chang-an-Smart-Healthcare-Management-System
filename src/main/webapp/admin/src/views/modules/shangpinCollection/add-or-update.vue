        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='shangpin'">
                    <el-form-item class="select" v-if="type!='info'"  label="药品" prop="shangpinId">
                        <el-select v-model="ruleForm.shangpinId" filterable placeholder="请选择药品" @change="shangpinChange">
                            <el-option
                ...
                <el-col :span="12"  v-if="sessionTable !='shangpin' ">
                    <el-form-item class="input" v-if="type!='info'"  label="药品类型" prop="shangpinValue">
