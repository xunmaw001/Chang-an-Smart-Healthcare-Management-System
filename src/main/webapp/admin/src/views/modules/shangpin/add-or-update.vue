    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品名称" prop="shangpinName">
                       <el-input v-model="ruleForm.shangpinName"
                                 placeholder="药品名称" clearable  :readonly="ro.shangpinName"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="药品名称" prop="shangpinName">
                           <el-input v-model="ruleForm.shangpinName"
                ...
                <el-col :span="24">
                    <el-form-item class="upload" v-if="type!='info' && !ro.shangpinPhoto" label="药品照片" prop="shangpinPhoto">
                        <file-upload
                            tip="点击上传药品照片"
                            action="file/upload"
                            :limit="3"
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinPhoto" label="药品照片" prop="shangpinPhoto">
                ...
                <el-col :span="12">
                    <el-form-item class="select" v-if="type!='info'"  label="药品类型" prop="shangpinTypes">
                        <el-select v-model="ruleForm.shangpinTypes" placeholder="请选择药品类型">
                            <el-option
                    ...
                    <div v-else>
                        <el-form-item class="input" label="药品类型" prop="shangpinValue">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品库存" prop="shangpinKucunNumber">
                       <el-input v-model="ruleForm.shangpinKucunNumber"
                                 placeholder="药品库存" clearable  :readonly="ro.shangpinKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="药品库存" prop="shangpinKucunNumber">
                           <el-input v-model="ruleForm.shangpinKucunNumber"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="药品原价" prop="shangpinOldMoney">
                       <el-input v-model="ruleForm.shangpinOldMoney"
                                 placeholder="药品原价" clearable  :readonly="ro.shangpinOldMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="药品原价" prop="shangpinOldMoney">
                           <el-input v-model="ruleForm.shangpinOldMoney"
               ...
               <el-col :span="12">
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="药品简介" prop="shangpinContent">
                    ...
                    <div v-else>
                        <el-form-item v-if="ruleForm.shangpinContent" label="药品简介" prop="shangpinContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   shangpinContent: [
                              { required: true, message: '药品简介不能为空', trigger: 'blur' },
                          ],
                }
            };
        },
